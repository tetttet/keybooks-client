...
const AboutPage = () => {
  ...
  return (
    <main className="bg-gradient-to-br from-[#0f1720] to-[#18202d] min-h-[60vh]">
      <section className="max-w-3xl mx-auto px-4 py-24 lg:py-36 text-white lg:text-center">
        <h1 className="text-4xl font-bold mb-6 lg:text-center">{t("title")}</h1>
        <p
          className="text-lg mb-4 custom-paragraph"
        ...
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: t
              .raw("p2")
              .replace(/<br\s*\/?>/g, '<div class="py-2"></div>'),
          }}
        />
